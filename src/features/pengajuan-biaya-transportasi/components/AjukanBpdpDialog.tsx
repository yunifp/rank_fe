...
export const AjukanBpdpDialog: FC<AjukanBpdpDialogProps> = ({
  ...
  const mutation = useMutation({
    ...
    }) => biayaTransportasiService.ajukanKeBpdp(payload),
    onSuccess: (res) => {
      if (res.success) {
        ...
        queryClient.invalidateQueries({
          queryKey: ["log-pengajuan", "biaya-transportasi", idPengajuan],
        });
        setOpen(false);
        form.reset();
      } else {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent size="sm" className="font-inter">
          <DialogHeader>
            ...
            <DialogDescription>
              Pilih hasil verifikasi pengajuan biaya transportasi.
            </DialogDescription>
          </DialogHeader>
