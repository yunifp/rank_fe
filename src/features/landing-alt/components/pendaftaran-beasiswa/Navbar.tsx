...
const Navbar: FC<NavbarProps> = ({ hasBeasiswaAktif, isBeasiswaLoading }) => {
  ...
  const handleDaftar = () => {
    navigate("/daftar-penerima-beasiswa");
    setIsMobileMenuOpen(false);
  };
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="flex items-center space-x-8">
              ...
              <Link to="/pendaftaran-beasiswa" className="nav-link">
                Beasiswa
              </Link>
            ...
            <div className="flex items-center space-x-2">
              {hasBeasiswaAktif && (
                <Button
                  onClick={() => navigate("/daftar-penerima-beasiswa")}
                  variant="outline"
                  className="border-amber-500 text-amber-500 hover:bg-amber-500 hover:text-white flex items-center gap-2">
