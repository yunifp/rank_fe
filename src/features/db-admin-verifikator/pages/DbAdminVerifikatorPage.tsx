  ...
  return (
    <div>
      ...
      <p className="text-xl font-semibold mt-4">
        Database Operator & Verifikator Lembaga Pendidikan
      </p>
          ...
          rightHeaderContent={
            <div className="flex gap-2 items-center">
              {canCreate && (
                <Button
                  onClick={() => {
                    navigate("/database/user-admin-verifikator/create");
                  }}
                  variant={"outline"}
                  size={"sm"}
                >
...
export default DbAdminVerifikatorPage;
