...
export const DownloadRekapButton = ({ idBatch }: Props) => {
  ...
  const handleDownload = async () => {
    try {
      ...
      const response = await biayaBukuService.generateRekap(idBatch);
      ...
      let filename = "rekap-biaya-buku.pdf";
      ...
      document.body.appendChild(link); // diperlukan di beberapa browser
      link.click();
      link.remove();
