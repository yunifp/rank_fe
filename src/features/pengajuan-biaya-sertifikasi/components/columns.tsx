...
import type { ITrxBiayaSertifikasiPksWithPks } from "@/types/biayaSertifikasi";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const handleDownloadRab = async (idBiayaSertifikasi: number) => {
  try {
    const blob = await biayaSertifikasiService.generateRab(idBiayaSertifikasi);
...
type GetColumnsProps = {
  ...
  onStaffBeasiswa: (biayaSertifikasi: ITrxBiayaSertifikasiPksWithPks) => void;
  onVerifikatorPjk: (biayaSertifikasi: ITrxBiayaSertifikasiPksWithPks) => void;
  onShowLog: (biayaSertifikasi: ITrxBiayaSertifikasiPksWithPks) => void;
...
export const getColumns = ({
  ...
  isVerifikatorPjk,
}: GetColumnsProps): ColumnDef<ITrxBiayaSertifikasiPksWithPks>[] => [
  {
    id: "no",
    header: "No",
