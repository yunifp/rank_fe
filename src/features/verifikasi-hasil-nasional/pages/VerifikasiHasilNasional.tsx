...
const VerifikasiHasilNasional = () => {
  ...
  const handleSelectProvinsi = (kodeProvinsi: string, namaProvinsi: string) => {
    navigate(
      `/verifikasi-hasil-nasional/pendaftar/provinsi/${kodeProvinsi}?nama=${encodeURIComponent(namaProvinsi)}`,
    );
  };
  ...
  return (
    <>
      <CustBreadcrumb items={[{ name: "Verifikasi Hasil Nasional" }]} />

      {/* Page Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-5">
        <div>
          <h1 className="text-xl font-bold text-foreground">
            Verifikasi Hasil Nasional
          </h1>
...
export default VerifikasiHasilNasional;
