...
const DataList = () => {
  ...
  const {
    ...
    queryKey: ["validitas-ipk-mahasiswa", page, debouncedSearch],
    retry: false,
    refetchOnWindowFocus: false,
    queryFn: () => {
      return validitasIpkMahasiswaService.getByPagination(
        page,
        debouncedSearch,
      );
    },
  ...
  const data: IValiditasIpkMahasiswa[] = response?.data?.result ?? [];
