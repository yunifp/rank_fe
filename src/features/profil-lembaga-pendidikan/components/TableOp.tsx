...
export function TableOp({ id_lembaga_pendidikan }: TableOpProps) {
  const {
    data: oPresponse,
    ...
    queryKey: ["profil-lembaga-pendidikan", "op-pr", id_lembaga_pendidikan],
    retry: false,
    refetchOnWindowFocus: false,
    queryFn: () => authService.getOpPt(id_lembaga_pendidikan),
