...
export interface PaginatedBiayaPendidikanPksResponse {
  result: ITrxBiayaPendidikanPksWithPks[];
  total: number;
  current_page: number;
  total_pages: number;
}

export const biayaPendidikanPksCreateSchema = z.object({
  semester: z
    .string({
...
export type BiayaPendidikanPksCreateFormData = z.infer<
  typeof biayaPendidikanPksCreateSchema
>;

export interface ITrxBiayaPendidikanPks {
  id: number;
  ...
  ttd_nominatif_ppk: string | null;
  ttd_nominatif_bendahara: string | null;
}

export interface ITrxBiayaPendidikanPksWithPks extends ITrxBiayaPendidikanPks {
  ...
  file_laporan_kegiatan_semester: string | null;
...
export const staffBeasiswaSchema = z
  .object({
    ...
    jumlah_biaya_pendidikan: z.coerce.number(),
...
export interface PaginatedBatchBiayaPendidikanPksResponse {
  result: IBatchBiayaPendidikanPks[];
  total: number;
  current_page: number;
  total_pages: number;
}

export interface IBatchBiayaPendidikanPks {
  id: number;
  nama: string;
  semester: string;
  tahun: string;
