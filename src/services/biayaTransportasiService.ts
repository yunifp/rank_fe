...
import type {
  ...
  BiayaTransportasiPksCreateFormData,
  GetLockDataRequest,
  ITrxBiayaTransportasiPks,
  ListBuktiPengeluaranWithMahasiswa,
  PaginatedBatchBiayaTransportasiPksResponse,
  PaginatedBiayaTransportasiPksResponse,
...
export const biayaTransportasiService = {
  getBiayaTransportasiByPks: async (
    idTrxPks: number,
  ): Promise<Response<ITrxBiayaTransportasiPks[]>> => {
    const response = await axiosInstanceJson.get(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/${idTrxPks}`,
    );
    return response.data;
  },
  createBiayaTransportasiPks: async (
    idTrxPks: number,
    data: BiayaTransportasiPksCreateFormData,
    ...
    const response = await axiosInstanceJson.post(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi`,
      insertData,
    );
    return response.data;
  },
  getBiayaTransportasiByPagination: async (
    page: number = 1,
    search: string = "",
  ): Promise<Response<PaginatedBiayaTransportasiPksResponse>> => {
    const response = await axiosInstanceJson.get(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi`,
      {
        params: {
  ...
  ajukanKeVerifikator: async (
    ...
    if (data.tahap) formData.append("tahap", data.tahap);
    ...
    const response = await axiosInstanceFormData.post(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/ajukan-ke-verifikator`,
      formData,
    );
  ...
  staffBeasiswa: async (
    ...
    const response = await axiosInstanceFormData.post(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/staff-beasiswa/${idBiayaTransportasi}`,
      formData,
    );
  ...
  verifikatorPjk: async (
    ...
    const response = await axiosInstanceFormData.post(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/verifikator-pjk/${idBiayaTransportasi}`,
      formData,
    );

    return response.data;
  },
  getPaginatedBatchBiayaTransportasi: async (
    page: number = 1,
    search: string = "",
  ): Promise<Response<PaginatedBatchBiayaTransportasiPksResponse>> => {
    const params: any = {
      page,
      search,
    };
    ...
    const response = await axiosInstanceJson.get(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/batch`,
      { params },
    );
    return response.data;
  },

  getBiayaTransportasiByBatchAndPagination: async (
    idBatch: number,
    page: number = 1,
    search: string = "",
  ): Promise<Response<PaginatedBiayaTransportasiPksResponse>> => {
    const response = await axiosInstanceJson.get(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/batch/${idBatch}`,
      {
        params: {
          page,
          search,
  ...
  ajukanKeBpdp: async (payload: {
    ...
    const response = await axiosInstanceJson.post(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/ajukan-ke-bpdp/${payload.idPengajuan}`,
      {
  ...
  generateRab(idBiayaTransportasi: number): Promise<Blob> {
    return axiosInstanceJson
      .get(
        `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/generate-rab/${idBiayaTransportasi}`,
        {
          responseType: "blob",
        },
      )
  ...
  getTagihanTahapLalu: async (
    ...
    const response = await axiosInstanceJson.get(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/tagihan-tahap-lalu/${idBiayaTransportasi}`,
    );
    return response.data;
  },

  batchBiayaTransportasi: async (
    kodeBatch: string,
    ids: string,
  ): Promise<Response<null>> => {
    const response = await axiosInstanceJson.post(
  ...
  generateNominatif(idTrxPks: number): Promise<Blob> {
    return axiosInstanceJson
      .get(
        `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/generate-nominatif/${idTrxPks}`,
        {
          responseType: "blob",
        },
      )
  ...
  generatePernyataanKeaktifanMahasiswa(idTrxPks: number): Promise<Blob> {
    return axiosInstanceJson
      .get(
        `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/generate-pernyataan-keaktifan-mahasiswa/${idTrxPks}`,
        {
          responseType: "blob",
        },
      )
  ...
  generateSuratPenagihan(idTrxPks: number): Promise<Blob> {
    return axiosInstanceJson
      .get(
        `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/generate-surat-penagihan/${idTrxPks}`,
        {
          responseType: "blob",
        },
      )
  ...
  generateNominatifGabungan(idBatch: number): Promise<Blob> {
    return axiosInstanceJson
      .get(
        `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/batch/${idBatch}/generate-nominatif`,
        {
          responseType: "blob",
        },
      )
  ...
  generateSptjm({
    ...
    return axiosInstanceJson
      .post(
        `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/generate-sptjm`,
        payload, // ✅ ini body
        {
  ...
  generateBuktiKwitansi({
    ...
    const payload = { id_trx_pks, nominal, total_mahasiswa_aktif, tahap };

    return axiosInstanceJson
      .post(
        `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/generate-bukti-kwitansi`,
        payload, // ✅ ini body
        {
          responseType: "blob", // ✅ ini config
        },
  ...
  ppkBendahara: async (
    ...
    const response = await axiosInstanceFormData.put(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/batch/${idBatch}/ppk-bendahara`,
      formData,
    );
  ...
  getLockedDataPks: async (
    ...
    const response = await axiosInstanceJson.post(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/get-lock-data`,
      data,
    );
  ...
  getListBuktiPengeluaran: async (
    idTrxPks: string,
    tahap: string,
  ): Promise<Response<ListBuktiPengeluaranWithMahasiswa[]>> => {
    const response = await axiosInstanceJson.post(
      `${MAHASISWA_PKS_SERVICE_BASE_URL}/pengajuan-pks/biaya-transportasi/mahasiswa-bukti-pengeluaran`,
      {
        id_trx_pks: idTrxPks,
        tahap,
      },
